...
public class Consultas {
	...
	= "UPDATE EMPLOYEES SET salary = (salary * 1.2) "
			...
			+ "'Administration' or "
			+ "department_name = 'IT')";
	public static final String CONSULTA_HISTORICO_AUMENTOS_SALARIO = "SELECT EMPLOYEE_ID, SALARIO_ANTERIOR, SALARIO_POSTERIOR, FECHA FROM INCREMENTOS_SALARIO WHERE FECHA > '25/01/17'";
}
